...
DEFAULT_IMU_FILTER_BUFFER_SIZE = 10
DEFAULT_IMU_DEADZONE = 0
DEFAULT_IMU_MAX_ANGLE = 45
DEFAULT_IMU_TWIST_DEADZONE = 2
DEFAULT_IMU_TWIST_MAX_RATE = 90
DEFAULT_IMU_YAW_LEAK_TIME = 3
...
SENSOR_CONFIG_FLAG_ENABLE = 1 << 0
SENSOR_CONFIG_FLAG_INVERT_ROLL = 1 << 1
SENSOR_CONFIG_FLAG_INVERT_PITCH = 1 << 2
SENSOR_CONFIG_FLAG_INVERT_YAW = 1 << 3
