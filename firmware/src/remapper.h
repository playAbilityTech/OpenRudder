...
#define IMU_ACTION_USAGE_PAGE 0xFFF80000
#define DPAD_USAGE_PAGE 0xFFF90000

#define RECENTER_IMU_USAGE (IMU_ACTION_USAGE_PAGE | 1)
#define PAUSE_IMU_USAGE (IMU_ACTION_USAGE_PAGE | 2)
#define RESUME_IMU_USAGE (IMU_ACTION_USAGE_PAGE | 3)
